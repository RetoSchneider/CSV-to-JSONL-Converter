...
function App() {
  ...
  const handleCopyToClipboard = useCallback(() => {
    ...
    navigator.clipboard
      .writeText(processedData.jsonlContent)
      .then(() => {
        setCopySuccess(true);
          ...
          additionalMetaTags={[
            {
              name: 'keywords',
              content:
                'CSV to JSONL, OpenAI, JSONL converter, token counter, data preprocessing, AI training data, ChatGPT',
            },
          ]}
        />
      </Suspense>
      <div className="retro-container" role="application">
        ...
        <main className="retro-main" role="main">
          <div className="retro-tagline">
            <p>
              Transform your CSV data into OpenAI-ready JSONL format with instant token counting
            </p>
          </div>
                ...
                <div className="stats-section">
                  <div className="stats-grid">
                    <div className="stat-card">
                      ...
                      <div className="stat-value filename" title={processedData.fileName}>
                    ...
                    <div className="stat-card">
                      ...
                      <div className="stat-value token-count">
                        {processedData.totalTokens.toLocaleString()}
                      </div>
                    </div>
                    <div className="stat-card">
                      <div className="stat-label">Est. cost</div>
                      <div className="stat-value">
                        ${((processedData.totalTokens / 1000) * 0.0004).toFixed(4)}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="action-buttons">
                    ...
                    <button
                      ...
                      className={`retro-btn ${copySuccess ? 'success-btn' : 'accent-btn'}`}
                      aria-label="Copy JSONL content to clipboard"
                    >
                      <span className="btn-icon" aria-hidden="true">
                        {copySuccess ? '✓' : '📋'}
                      </span>
                    ...
                    >
                      <table className="retro-table" aria-describedby="table-desc">
                        <caption id="table-desc" className="sr-only">
                          Preview of first few rows from the CSV data
                        </caption>
                        <thead>
                          <tr>
                              ...
                              {Object.entries(row).map(([_, value], i) => {
                                ...
                                return (
                                  <td
                                    ...
                                    title={displayValue}
                                    {...(i === 0
                                      ? { 'aria-label': `Row ${rowIndex + 1}, ${displayValue}` }
                                      : {})}
                                  >
                                    {displayValue}
                                  </td>
        ...
        <footer className="retro-footer" role="contentinfo">
          ...
          <div className="footer-content">
            <p>
              ...
              <button onClick={handleBuyMeCoffee} className="footer-coffee-link">
                buy me a coffee
              </button>{' '}
